...
<span style="background:#f2f2f2; padding:6px 12px; border-radius:20px;">Embedded Systems</span>
<span style="background:#f2f2f2; padding:6px 12px; border-radius:20px;">RTOS</span>
<span style="background:#f2f2f2; padding:6px 12px; border-radius:20px;">PCB Design</span>
<span style="background:#f2f2f2; padding:6px 12px; border-radius:20px;">Firmware Development</span>
<span style="background:#f2f2f2; padding:6px 12px; border-radius:20px;">Hardware-Software Integration</span>
